...
const Review = props => {
  return (
    <Flex flexDirection="column" mt={{base: "", md: "40px"}}>
      {props.checkoutToken.live.line_items.map((product) => (
        <Flex flexDirection="column" key={product.name} mb={{base: "", md: "30px"}} bg="gray.100" p="20px 20px 20px 20px" borderRadius="10px">
