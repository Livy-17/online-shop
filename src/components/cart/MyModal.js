    ...
    <Modal isOpen={props.isOpen} onClose={props.onClose} placement={props.placement} finalFocusRef={props.finalFocusRef} >
      ...
      <ModalContent overflow='scroll' width='80vw'>
        ...
        <Box mt='20px'>
          ...
          <ModalFooter>
            <Flex>
              <Button mr='10px' w='125px' variant="outline" bg="red.100" onClick={() => {props.handleEmptyCart(); props.onClose();}}>Empty Cart</Button>
              <Button w='125px' variant="solid" bg="blue.100" as={Link} to="/checkout" onClick={props.onClose}>Checkout</Button>
            </Flex>
