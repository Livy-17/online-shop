...
const Navbar = props => {
  ...
  return (
    <Box w="100vw" zIndex="99">
      ...
      <Flex alignItems="center" bg="rgba(40, 40, 40, 0.3)" backdropFilter="blur(10px)" position="fixed" top="0" w="100vw" h={{base: "50px", md: "60px"}}>
        <Heading as={Link} to="/" size="md" mr={{base: "10px", md: "30px"}} color="white" ml={{base: "10px", md: "30px"}} _hover={{cursor: "pointer"}} >EpicShoes</Heading>
        ...
        <Flex alignItems="center" justifyContent="center" bg={{base: "rgba(40, 40, 40, 0.1)", md: "rgba(40, 40, 40, 0.3)"}} borderRadius="10px" w={{base: "60px", md: "60px"}} mr={{base: "10px", md: "40px"}}>
